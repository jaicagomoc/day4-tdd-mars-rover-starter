...
//            if(location.getDirection() == Direction.EAST){location.setDirection(Direction.EAST);}
//            if(location.getDirection() == Direction.WEST){location.setDirection(Direction.EAST);}
            extracted();
        }
